...
const Create = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const blog = { title, body, author } //this creates the object (console.log 'blog' and you will see)
    ...
    setTimeout(() => { //We set this to make the 'Adding Blog...' message more realistic.
      fetch('http://localhost:8000/blogs', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' }, //like this always(it's telling the server what kind of data we are sending with this request, json data)
